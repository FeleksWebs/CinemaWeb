...
function startAnim(){
  setTimeout(function(){
      ...
      setTimeout (function(){$('.Second-Image').animate({width: '100%'},'slow','linear')},DisplayTime-1);
      ...
      setTimeout (function(){$('.Third-Image').animate({width: '100%'},'slow','linear')},DisplayTime-1);
    ...
    function ThirdAnim(){
      setTimeout (function(){$('.Third-Image').animate({width: '0px'},'slow','linear')},DisplayTime-1);
      setTimeout (function(){$('.Third-Image').css('left','')},SwitchToRight);  

      setTimeout (function(){$('.First-Image').animate({width: '100%'},'slow','linear')},DisplayTime);
